        ...
        http    //authorizeHttpRequests 어떤 요청에 대해 어떤 권한이 필요한지 설정
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 인증 없이 접근 가능
                                ...
                                .requestMatchers("/member/mypage", "/mypage", "/update-profile","/update-phone", "/update-password", "/login-log", "/withdraw-account", "/coupons").hasRole("USER") // 일반유저 권한을 가진 사용자만 접근 (추후 수정)
