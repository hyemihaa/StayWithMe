        ...
        http    //authorizeHttpRequests 어떤 요청에 대해 어떤 권한이 필요한지 설정
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 인증 없이 접근 가능
                                ...
                                .requestMatchers("/tour","/hotel-single/**", "/get-list", "/get-place-items").permitAll()
                                .requestMatchers("/static/**", "/web-login", "/accommodationImages/**").permitAll()
                                .requestMatchers("/enroll", "/save-location", "/couponList", "/addCoupon", "/add-all", "/refund/complete", "/refund", "/getRoomImages/**","/payments/complete","/payment","/reservation", "/reserve-save","/apply-coupon","/refund","/refund/complete").permitAll()
